...
const Header = () => {
    ...
    return (
        <>
            <header className="bg-background fixed top-0 w-full flex justify-center antialiased z-10">
                <div className="w-full flex p-6 items-center gap-5 justify-between md:justify-center">
                    <a href="/">
                        <Image
